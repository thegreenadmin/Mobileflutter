      ...
      child: Scaffold(
        ...
        body: Obx(
          () => IndexedStack(
            ...
            children: [
              const TabNav(0, HomeScreen()),
              const TabNav(1, WalletScreen()),
              roleApp.value == Role.storeOwnerRoleText
                  ? bottomNavigationPageController.storeList.length > 1 ||
                      ...
                      ? const TabNav(2, OrderStoresListScreen())
                      : const TabNav(3, OrdersHomeMainScreen())
                  : const TabNav(4, OrdersScreen()),
              const TabNav(5, OffersScreen()),
              const TabNav(6, MoreScreen()),
            ],
          ),
        ),
...
/// sub navigators.
class TabNav extends GetView<BottomNavController> {
  final int navKey;
  final Widget tab;
  const TabNav(this.navKey, this.tab);
