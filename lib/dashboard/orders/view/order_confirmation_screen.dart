             ...
             Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  ...
                  image: ordersController.storeDetailsResponse.value.data!.store!.image!.dynamicUrl == null ||
                      ordersController.storeDetailsResponse.value.data!.store!.image!.dynamicUrl!.isEmpty
                      ? const AssetImage(ImageConstants.storeicon)
                  as ImageProvider
                      : NetworkImage(ordersController.storeDetailsResponse.value.data!.store!.image!.dynamicUrl!),
                ),
              ),
              child: Padding(
                      ...
                      Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onTap: () {
                                   ordersController
                                    .apiRemoveFavouriteStore(ordersController.storeDetailsResponse.value.data?.store?.storeId);
                              },
                              child: Image.asset(
                              ...
                              onTap: () {
                                    ...
                                    .apiCreateFavouriteStore(
                                         ordersController.storeDetailsResponse.value.data?.store?.storeId);
                              },
                              child: Image.asset(
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              backgroundImage: ordersController
                                  .storeDetailsResponse.value.data!.store!.logo!.dynamicUrl == null ||
                                ordersController.storeDetailsResponse.value.data!.store!.logo!.dynamicUrl!.isEmpty
                                  ? const AssetImage(
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                 ordersController.storeDetailsResponse.value.data!.store!.storeName ?? "",
                                  ...
                                  SizedBox(
                                    ...
                                    child: Text(
                                          ordersController.storeDetailsResponse.value.data!.store!
                                            .storeAddresses!.first.addressLine1 ?? "",
                                        style: const TextStyle(
                                            overflow:
                                            TextOverflow.visible, color: AppColors.white, fontSize: 16,
                                            fontWeight:
                                            FontWeight.w400)),
                                  ),
                                ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    ordersController
                                            ...
                                            .value.data!.store!.storeTimings!.isNotEmpty ? ordersController
                                            .storeDetailsResponse
                                            .value.data!.store!.storeTimings!.first
                                        ...
                                        style: const TextStyle(
                                            overflow:
                                            TextOverflow.visible, color: AppColors.white,
                                        ...
                                        itemBuilder: (_, i) {
                                          return CircleAvatar(
                                            ...
                                            child: ordersController
                                                ...
                                                ?.store?.storeDeliveryServices?[i].deliveryServiceId == "1"
                                                ? Image.asset(
                                              ...
                                              color: Colors.white,
                                                ...
                                                .value.data?.store?.storeDeliveryServices?[i].deliveryServiceId == "2"
                                                ? Image.asset(
