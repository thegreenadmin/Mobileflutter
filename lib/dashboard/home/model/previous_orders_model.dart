...
class PreviousOrdersModel {
  ...
  PreviousOrdersModel({this.status, this.message, this.data});

  PreviousOrdersModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data =
        json['data'] != null ? PreviousOrdersData.fromJson(json['data']) : null;
  }
...
class PreviousOrdersData {
  int? totalCount;
  List<PreviousOrdersProducts>? products;

  PreviousOrdersData({this.totalCount, this.products});

  PreviousOrdersData.fromJson(Map<String, dynamic> json) {
    totalCount = json['total_count'];
    if (json['products'] != null) {
      products = <PreviousOrdersProducts>[];
      json['products'].forEach((v) {
        products!.add(PreviousOrdersProducts.fromJson(v));
      });
    }
  }
...
class PreviousOrdersProducts {
  ...
  PreviousOrdersProducts.fromJson(Map<String, dynamic> json) {
