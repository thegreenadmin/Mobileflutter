class OwnerInboxModel {
  ...
  OwnerInboxModel({this.status, this.message, this.data});

  OwnerInboxModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['message_heads'] != null) {
      messageHeads = <MessageHead>[];
      json['message_heads'].forEach((v) {
        messageHeads!.add(new MessageHead.fromJson(v));
      });
    }
  }
...
class MessageHead {
  ...
  MessageHead.fromJson(Map<String, dynamic> json) {
