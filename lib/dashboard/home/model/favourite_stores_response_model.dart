...
//
//     final favouriteStoreResponse = favouriteStoreResponseFromJson(jsonString);
...
class FavouriteStoreAddress {
  ...
  FavouriteStoreAddress copyWith({
    String? id,
    String? storeId,
    String? stateId,
    String? addressName,
...
class FavouriteStoreDeliveryService {
  ...
  FavouriteStoreDeliveryService copyWith({
    String? storeDeliveryServiceId,
    String? deliveryServiceId,
    bool? isEnabled,
    String? status,
