...
EditWorkerRequest editWorkerRequestFromJson(String str) =>
    EditWorkerRequest.fromJson(json.decode(str));

String editWorkerRequestToJson(EditWorkerRequest data) =>
...
class EditWorkerRequest {
  ...
  factory EditWorkerRequest.fromJson(Map<String, dynamic> json) =>
      EditWorkerRequest(
        storeId: json["store_id"],
        storeUserId: json["store_user_id"],
        description: json["description"],
