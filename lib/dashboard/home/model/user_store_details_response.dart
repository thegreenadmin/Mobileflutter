...
class Store {
    ...
    factory Store.fromJson(Map<String, dynamic> json) => Store(
        ...
        storePages: json["store_pages"] == null ? [] : List<StorePage>.from(json["store_pages"]!.map((x) => StorePage.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "store_pages": storePages == null ? [] : List<dynamic>.from(storePages!.map((x) => x.toJson())),
    };
}
