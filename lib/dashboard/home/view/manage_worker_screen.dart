              ...
              children: [
                Obx(
                  () => Text(
                    ...
                    "${addNewWorkerController.workerList.length} Members": "${addNewWorkerController.workerList.length} Member",
                    style: const TextStyle(
                        fontSize: 18.0,
                        color: AppColors.black,
                        fontWeight: FontWeight.w600),
                                                      ...
                                                      children: [
                                                        Text(
                                                          "${concatenate.toString() ?? ''} \n "
                                                              "${addNewWorkerController.workerList[index].storeUserTimings != null
                                                              && addNewWorkerController.workerList[index].storeUserTimings!.isNotEmpty ?
                                                          "${ Utility.formatDateTime(
                                                              addNewWorkerController.workerList[index].storeUserTimings?.first.startTime ?? "",
                                                              firstFormat: "hh:mm:ss", secFormat: "hh:mm a").toString()} - "
                                                              "${Utility.formatDateTime(
                                                              addNewWorkerController.workerList[index].storeUserTimings?.first.endTime ?? "",
                                                              firstFormat: "hh:mm:ss", secFormat: "hh:mm a").toString()} " : ""}",
                                                          style: TextStyle(
