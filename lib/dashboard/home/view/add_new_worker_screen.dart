                  ...
                  children: [
                    ...
                    Obx(() => addNewWorkerController.getUserStoreList.isEmpty
                        ...
                        : DropdownButtonFormField<UserStoresList>(
                            isExpanded: true,
                            value: addNewWorkerController.storeId.toString() !=
                                        null &&
                                    addNewWorkerController.storeId.toString() !=
                                        "0"
                                ? addNewWorkerController.getUserStoreList
                                    .firstWhere((element) =>
                                        element.storeId ==
                                        addNewWorkerController.storeId
                                            .toString())
                                : null,
                            decoration: InputDecoration(
                              enabledBorder: UnderlineInputBorder(
