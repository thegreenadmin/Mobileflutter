...
class UserStoreOrderAppBar extends StatefulWidget  with PreferredSizeWidget{
  ...
  Size get preferredSize => Size.fromHeight(WidgetConstants.screenHeight * 0.18);
}
                                ...
                                children: [
                                  Text(
                                      storeHomeMainController
                                          .storeDetailsResponse
                                          .value
                                          .data!.store!.storeTimings!
                                          .isNotEmpty ? storeHomeMainController
                                  ...
                                  ListView.separated(
                                      ...
                                      itemCount: storeHomeMainController
                                          .storeDetailsResponse
                                          .value
                                          .data?.store?.storeDeliveryServices
                                          ?.length ?? 0,
                                      itemBuilder: (_, i) {
                                        return
                                          CircleAvatar(
                                            ...
                                            child:  storeHomeMainController
                                                ...
                                                .deliveryServiceId == "1"
                                                ?
                                            Image.asset(ImageConstants.instore,
                                              scale: 4.5,
                                              color: Colors.white,
                                            )
                                                : storeHomeMainController
                                                ...
                                                .deliveryServiceId == "2"
                                                ? Image.asset(
                                              ImageConstants.delivery, color: Colors.white,
                                              scale:  4.5,)
                                                : Image.asset(
                                              ImageConstants.curb, color: Colors.white,
                                              scale: 3.5,),
                                          );
                      ...
                      children: [
                        Container(
                          ...
                          child: CircleAvatar(
                            radius: 28.0,
                            backgroundImage: storeHomeMainController
                                .storeAddress.value.store?.logo
                                ?.dynamicUrl == null ||
                                storeHomeMainController.storeAddress.value.store!
                                    .logo!.dynamicUrl!.isEmpty
                                ? const AssetImage(
                              ImageConstants.nopicfound,
                            ) as ImageProvider
                                : NetworkImage(storeHomeMainController.storeAddress.value.store?.logo?.dynamicUrl
                                .toString() ?? ""),
                            backgroundColor: Colors.transparent,
                          ),
                        ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  ListView.separated(
                                      ...
                                      // physics: const NeverScrollableScrollPhysics(),
                                      scrollDirection: Axis.horizontal,
                                      itemCount: storeHomeMainController.storeAddress
                                          .value.store?.storeDeliveryServices
                                          ?.length ?? 0,
                                      itemBuilder: (_, i) {
                                        return
                                          CircleAvatar(
                                            radius: 12.0,
                                            backgroundColor: AppColors.primary,
                                            child:  storeHomeMainController.storeAddress
                                                .value.store
                                                ?.storeDeliveryServices?[i]
                                                .deliveryServiceId == "1"
                                                ?
