...
class HomeOffersDetailScreen extends StatefulWidget {
  const HomeOffersDetailScreen({super.key});

  @override
  State<HomeOffersDetailScreen> createState() => _HomeOffersDetailScreenState();
}

class _HomeOffersDetailScreenState extends State<HomeOffersDetailScreen> {
