                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          Get.parameters["storeId"] =
                              searchStoreUserController.previousStore[index].storeId ?? "";
                          print("nearby store is data : ---------------------------------------------" );
                          print(searchStoreUserController.previousStore[index].storeId );
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Visibility(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    searchStoreUserController.previousStore[index].storeAddresses!=null &&
                                                        searchStoreUserController.previousStore[index].storeAddresses!.isNotEmpty?
                                                    searchStoreUserController.previousStore[index].storeAddresses?.first.addressLine1 ??
                                                        "":"",
                                          ...
                                          height4SizedBox,
                                          Text(
                                              searchStoreUserController.previousStore[index]
                                                  .storeTimings!
                                                  .isNotEmpty
                                                  ? searchStoreUserController.previousStore[index].storeTimings
                                                  ?.first.is24HoursActive == false
                                ...
                                children: [
                                  Expanded(
                                    child: ListView.separated(
                                        ...
                                        itemCount: searchStoreUserController.previousStore[index]
                                            ...
                                            children: [
                                              searchStoreUserController.previousStore[index]
                                                ...
                                                scale: 2.5,
                                                  ...
                                                  : searchStoreUserController.previousStore[index].storeDeliveryServices?[
                                              i]
                                                  .deliveryServiceId ==
                                                  "2"
                                                  ? Image.asset(
                                              ...
                                              width3SizedBox,
                                              Text(
                                                searchStoreUserController.previousStore[index].storeDeliveryServices?[i]
                                                    .deliveryServiceName ??
                                                    "",
                                                style: const TextStyle(
                                                    fontSize: 12.0,
