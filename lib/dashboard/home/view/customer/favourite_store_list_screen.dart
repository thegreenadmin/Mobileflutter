                    ...
                    if (index <
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          print(searchStoreUserController.favouriteStore[index].storeId );
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            searchStoreUserController
                                                .favouriteStore[index].storeName ??
                                                "",
                                            style: const TextStyle(
                                                fontSize: 17.0,
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    searchStoreUserController
                                                        .favouriteStore[
                                                    index].storeAddresses!=null && searchStoreUserController
                                                        .favouriteStore[
                                                    index].storeAddresses!.isNotEmpty?
                                                    searchStoreUserController
                                                        .favouriteStore[
                                                    index].storeAddresses?.first.addressLine1 ??
                                                        "":"",
                                ...
                                children: [
                                  Expanded(
                                    child: ListView.separated(
                                        ...
                                        itemCount: searchStoreUserController
                                            .favouriteStore[index].storeDeliveryServices
                                            ?.length ??
                                            0,
                                        itemBuilder: (_, i) {
                                          return Row(
