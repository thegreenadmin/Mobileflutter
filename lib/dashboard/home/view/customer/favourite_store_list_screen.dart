      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Expanded(
          child: Obx(
                ...
                controller: searchStoreUserController.favouriteStoresScrollController,
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (index <
                    ...
                    if (!searchStoreUserController
                        .favouriteStoresScrollController.hasClients) {
                      Timer(const Duration(milliseconds: 10), () {
                        searchStoreUserController.favouriteStoresScrollController.jumpTo(
                            searchStoreUserController.favouriteStoresScrollController
