                ...
                child: Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(color: AppColors.primary, fontSize: 30, fontWeight: FontWeight.w600),
                    ),
                    height10SizedBox,
                    Text(
                      ...
                      style: TextStyle(
                          color: AppColors.blacklight, fontSize: 16, height: 1.4, fontWeight: FontWeight.w400),
                    ),
                    height30SizedBox,
                    Padding(
                      ...
                      child: PinCodeTextField(
                        ...
                        errorTextSpace: 20,
                        textStyle: TextStyle(fontSize: 18, color: AppColors.blacklight, fontWeight: FontWeight.w500),
                        obscureText: true,
                        appContext: context,
